...
(library Library_1
	...
	(patternDef "WR-COM_USB_TYPE_B" (originalName "WR-COM_USB_TYPE_B")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.46403, 3.79232) (textStyleRef "Default") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -6 8) (pt 6 8) (width 0.254))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6 8) (pt 6 -10.3) (width 0.254))
		)
		(layerContents (layerNumRef 28)
			(line (pt 6 -10.3) (pt -6 -10.3) (width 0.254))
		)
		(layerContents (layerNumRef 28)
			(line (pt -6 -10.3) (pt -6 8) (width 0.254))
		)
		(layerContents (layerNumRef 18)
			(line (pt -6 8) (pt 6 8) (width 0.254))
		)
	...
	(compDef "692221030100" (originalName "692221030100") (compHeader (numPins 9) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "http://katalog.we-online.de/em/datasheet/692221030100.pdf")
	)
